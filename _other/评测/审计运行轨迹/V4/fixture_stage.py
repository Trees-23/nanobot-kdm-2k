#!/usr/bin/env python3
"""Run the frozen staging implementation with V4-owned assets and target paths."""
...
spec = importlib.util.spec_from_file_location("audit_trace_v4_fixture_stage_impl", V2_SCRIPT)
